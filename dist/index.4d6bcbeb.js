...
const popularMovies = await (0, _networkJs.getMovies)();
const searchForm = document.getElementById("searchForm");
const searchInput = document.getElementById("searchInput");
popularMovies.forEach((movie)=>{
    (0, _uiJs.renderMovie)(movie);
});
searchForm.addEventListener("submit", (event)=>{
    ...
    if (query === "") {
        ...
        const filteredMovies = popularMovies.filter((movie)=>movie.title && movie.title.toLowerCase().includes(query) || movie.overview && movie.overview.toLowerCase().includes(query));
...
const getMovies = async ()=>{
    try {
        const res = await fetch("https://api.themoviedb.org/3/movie/popular?api_key=21ec068df2a5c774ca7f82bbda35c458&page=1");
...
},{}],"lFOPJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const renderMovie = (movie)=>{
    ...
    info.className = "absolute bottom-0 from-white container px-4 py-2 bg-gray-500 bg-opacity-80";
    const heartSvg = `
...
},{"./storage.js":"bneaz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bneaz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
